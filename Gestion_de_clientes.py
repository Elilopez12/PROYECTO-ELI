...
class Gestiondeclientes:
    ...
    def registrar_cliente(self):
        ...
        Gestiondeclientes.compra(nuevo_cliente)
        return nuevo_cliente()
    
    def compra(cliente):
        while True:
            GestionProductos.mostrar_productos()
            cliente.carrito.append(GestionProductos.buscar_producto_por_nombre())
            añadir=input("Desea agregar otro producto? y/n")
            if añadir == "n":
                break
